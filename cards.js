...
const FLASHCARDS = [
  ...
  },
  {
    ...
    q: "Name real-world buffer overflow attacks.",
    a: "<ul><li><strong>Morris Worm</strong></li><li><strong>Code Red</strong></li><li><strong>SQL Slammer</strong></li><li><strong>Stagefright</strong></li></ul>"
  },
  ...
  },
  {
    ...
    a: "Using the <strong>EternalBlue SMB exploit</strong> on Windows systems."
  },
  ...
  {
    week: 6, category: "Web Architecture",
    q: "Why is HTTP stateless and how is this solved?",
    a: "HTTP has no memory between requests; <strong>cookies</strong> maintain sessions."
  },
  {
    week: 6, category: "Web Architecture",
  ...
  },
  {
    ...
    a: "It begins a comment; everything after it is ignored."
  },
  {
    week: 6, category: "SQL Injection",
  ...
  {
    week: 6, category: "SQLi Defences",
    q: "How can testers quickly detect SQLi?",
    a: "Entering a single quote <code>'</code> and checking for SQL/database errors."
  },
  {

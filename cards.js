const FLASHCARDS = [
...

  {
    ...
    a: "Args pushed to stack → return addr pushed → saved EBP → new frame."
  },
  ...
  {
    week: 2, category: "Stack Overflow",
    q: "Stack frame layout",
    a: "(High adress) Arguments, Return Adress, Saved EBP, Local variables (Low address)"
  },
